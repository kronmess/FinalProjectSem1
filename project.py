    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONUP and storemenu1.buySlingOutline.collidepoint(pygame.mouse.get_pos()):
            if target1.slingsPrice <=target1.shotCount:
                ...
                BPS += 1
                target1.slingsPrice += int(target1.slingsPrice //4/100 * target1.slingsPrice)
                buy_effect.play()
        ...
        if event.type == pygame.MOUSEBUTTONUP and storemenu1.buyRevolverOutline.collidepoint(pygame.mouse.get_pos()):
            if target1.revolversPrice <= target1.shotCount:
                ...
                BPS += 6
                target1.revolversPrice += int(target1.revolversPrice // 6.5/100 * target1.revolversPrice)
                buy_effect.play()
        ...
        if event.type == pygame.MOUSEBUTTONUP and storemenu1.buyRifleOutline.collidepoint(pygame.mouse.get_pos()):
            if target1.riflesPrice <=target1.shotCount:
                ...
                BPS += 300
                target1.riflesPrice += int(target1.riflesPrice // 90/100 * target1.riflesPrice)
                buy_effect.play()
        ...
        if event.type == pygame.MOUSEBUTTONUP and storemenu1.buyMinigunOutline.collidepoint(pygame.mouse.get_pos()):
            if target1.minigunsPrice <=target1.shotCount:
                ...
                BPS += 100
                target1.minigunsPrice += int(target1.minigunsPrice // 600/100 * target1.minigunsPrice)
                buy_effect.play()
